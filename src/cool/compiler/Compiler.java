...
//            });
        ...
        var astConstructionVisitor = new AstConstructorVisitor();
...
//        ast.accept(printVisitor);
        ...
        SymbolTable.defineBasicClasses(globalTree);

        var classDefVisitor = new ClassDefPassVisitor();
        ast.accept(classDefVisitor);
        var classResVisitor = new ClassResPassVisitor();
        ast.accept(classResVisitor);
        var defPassVisitor = new DefinitionPassVisitor();
        ast.accept(defPassVisitor);
        var classPassVisitor = new ClassPassVisitor();
        ast.accept(classPassVisitor);
        var resPassVisitor = new ResolutionPassVisitor();
        ast.accept(resPassVisitor);
        ...
        var code = ast.accept(codeGenVisitor);
